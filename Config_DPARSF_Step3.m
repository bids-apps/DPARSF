function Config_DPARSF_Step3(MatFile)
...
Cfg.IsRemoveFirstTimePoints=0; %Remove the first time points.
Cfg.RemoveFirstTimePoints=0; %How many time points should be removed.
Cfg.IsSliceTiming=0; %Slice timing
...
Cfg.IsRealign=0; %Realignment (head motion correction)
...
Cfg.IsAutoMask=0; %Calculate automasks. Similar to AFNI's 3dAutoMask

Cfg.IsNeedT1CoregisterToFun=0; %Coregister structural images to functional space
...
Cfg.IsSegment=0; %Segmentation: 1 for old segment; 2 for new segment.
